...
SECRET_KEY = 'django-insecure-(hf$!+5vxu4xwl+g2jz(pxn93um4kyp-d))t&j3gn!!3i7)cox'
...
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_PASSWORD', '')  # Set this as environment variable
